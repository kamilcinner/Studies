function oblicz() {
    ...
    //pobierz wartość (łańcuch tekstowy) wpisaną w polu formularza o id='l1':
    l1=l1.value;
    //Przekonwertuj (jeśli się uda) l1 do wartości typu int:
    l1=parseInt(l1);
    //Jeśli udała się próba konwersji to l1 zawiera wartość całkowitą
    //Analogicznie realizujemy pobranie wartości z drugiego pola tekstowego,
    //ale tym razem wszystko w jednej instrukcji:
