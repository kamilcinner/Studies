...
else unset($_SESSION['regSuccess']);
...
if (isset($_SESSION['g_login'])) unset($_SESSION['g_login']);
if (isset($_SESSION['g_email'])) unset($_SESSION['g_email']);
if (isset($_SESSION['g_reg'])) unset($_SESSION['g_reg']);
...
<body>
    ...
    <main>
        <article id="content">
            <div id="welcome">
                <header>Dziękujemy za rejestrację! :)</header>
            </div>
        </article>
    </main>
