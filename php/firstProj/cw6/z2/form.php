...
function printForm() {?>
    ...
    <div id="container">
        ...
        <form action="form.php" method="post">
            ...
            <input type="radio" id="id_ec" name="payment" value="Master Card"><label for="id_ec">Master Card</label>
            <input type="radio" id="id_vs" name="payment" value="Visa"><label for="id_vs">Visa</label>
            <input type="radio" id="id_pb" name="payment" checked value="Przelew"><label for="id_pb">przelew bankowy</label><br>
