#include <iostream>
#include "pytanie.h" // szukaj biblioteki w folderze z projektem
#include <fstream>
#include <cstdlib>

using namespace std;

void Pytanie::wczytaj() // chodzi mi o metode bedaca czescio klasy Pytanie, wtedy kompilator sie nie pomyli jezeli taka funkcja juz gzies istnieje
{
    fstream plik;
